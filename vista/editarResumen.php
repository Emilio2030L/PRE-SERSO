...
<?php
  ...
  $resultAll1 = mysqli_query($mysqli,"SELECT * FROM registroactividades INNER JOIN altalumno ON altalumno.idAlta = registroactividades.idAlta WHERE matriculaAlumno = '$ma'");  
...
<html lang="en">
  ...
  <body class="">
    ...
    <h5 class="text-dark text-center p-3">Editar resumen actividades</h5>

    <main>
    <form class="formulario" id="formulario" method="post" action="../control/editarActividad.php">
      <!-- Grupo: Id asignacion-->
      ...
      <div class="formulario__grupo" id="grupo__resumen">
        ...
        <div class="formulario__grupo-input">
          <textarea class="formulario__input" name="resumen" id="resumen"><?php echo $rowData1['resumen']; ?></textarea>
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error"></p>
      </div>

      <!-- Grupo: Apoyo económico -->
      <div class="formulario_grupo" id="grupo_apoyo">
        <label for="apoyo" class="formulario__label">¿Obtuviste apoyo económico?</label>
        <div class="formulario__grupo-input">
                    <select name="apoyo" class="formulario__input" id="apoyo">
                        <option value="<?php echo $rowData1['apoyo']; ?>" selected><?php echo $rowData1['apoyo']; ?></option> 
                        <option value="No">Sin apoyó económico</option>            
                        <option value="De 500 a 1000 pesos">De 500 a 1000 pesos</option>
                        <option value="De 1000 a 1500 pesos">De 1000 a 1500 pesos</option>
                        <option value="Más de 2000 pesos">Más de 2000 pesos</option>
                    </select> 
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error"></p>
      ...
      <div class="formulario_grupo" id="grupo_medio">
        ...
        <div class="formulario__grupo-input">
                    <select name="medio" class="formulario__input" id="medio">
                        <option value="<?php echo $rowData1['medio']; ?>" selected><?php echo $rowData1['medio']; ?></option>
                        <option value="Un amigo o familiar">Un amigo o familiar</option> 
                        <option value="Trabajo o trabaje ahí" >Trabajo o trabaje ahí</option>           

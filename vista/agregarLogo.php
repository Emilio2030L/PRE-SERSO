      ...
      <div class="mt-5">      
        <div class="mb-4">
            <form action="../control/agregarImagen.php" method="post" enctype="multipart/form-data" >
              <label class="text-dark">Agrege una descripción:</label>
              <br>
              <br>
              <textarea name="descripcion" rows="5" cols="40" placeholder="Describe la imagen"></textarea>
              <br>
              <br>
              ...
              <br>
              <br>
              <input class="primary btn-dark"  type="file" name="foto"><br><br>
              <button type="submit" class="btn btn-dark w-30">Registrar</button>
              <br>
              <br>
          </form> 
        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                <thead class="table-dark table-borderless" >
                                    <tr>
                                        ...
                                        <th style="text-align: center">URL imagen</th>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th style="text-align: center"><?php  echo $row['idImg']?></th>
                                                <th style="text-align: center"><?php  echo $row['descripcion']?></th>
                                                <th style="text-align: center"><?php  echo $row['lugarImg']?></th>
                                                <th style="text-align: center"><?php  echo $row['estado']?></th>
                                                <th style="text-align: center"><?php  echo $row['foto']?></th> 
                                                <th style="text-align: center"><a href="../vista/cambiarImagen.php?id=<?php echo $row['idImg'] ?>" class="btn btn-outline-primary" onclick="return confirmarActualiza()">Editar</a></th>
                                                <th style="text-align: center"><a href="../control/eliminarImagen.php?id=<?php echo $row['idImg'] ?>" class="btn btn-outline-danger" onclick="return confirmarBorrar()">Eliminar</a></th>
                                            </tr>
                                        <?php 
                                            }
                                        ?>

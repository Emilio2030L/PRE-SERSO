  ...
  <body class="">
    ...
    <form class="formulario" id="formulario">
      ...
      <div class="formulario_grupo" id="grupo_estadoliberacion">
        ...
        <div class="formulario__grupo-input">
                    <select name="estadoliberacion" class="formulario__input" id="estadoliberacion">
                      ...
                      <?php  }  ?>
                      <option value=0 >No iberado</option>
                      <option value=1 >Liberado</option>
                    </select> 
      ...
      <div class="formulario__grupo" id="grupo__nombreAlumno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="nombreAlumno" id="nombreAlumno" value="<?php echo $row['nombreAlumno']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario__grupo" id="grupo__apellidoPpaterno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="apellidoPpaterno" id="apellidoPpaterno" value="<?php echo $row['apellidoPpaterno']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El nombre tiene que ser de 4 a 20 dígitos y solo puede contener numeros, letras y guion bajo.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__fechaInicio">
        ...
        <div class="formulario__grupo-input">
          <input type="date" class="formulario__input" name="fechaInicio" id="fechaInicio" value="<?php echo $row['fechaInicio']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario__grupo" id="grupo__fechaFin">
        ...
        <div class="formulario__grupo-input">
          <input type="date" class="formulario__input" name="fechaFin" id="fechaFin" value="<?php echo $row['fechaFin']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">error seleccione fecha</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__telefonoAlumno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="telefonoAlumno" id="telefonoAlumno" value="<?php echo $row['telefonoAlumno']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario__grupo" id="grupo__generacion">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="generacion" id="generacion" value="<?php echo $row['generacion']  ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario_grupo" id="grupo_idPrograma">
        ...
        <div class="formulario__grupo-input">
                    <select name="idPrograma" class="formulario__input" id="idPrograma">
                        <option value="<?php echo $row['idPrograma'] ?>" selected><?php echo $row['idPrograma'] ?></option>
                        <?php
                        require("../conexion/connect_db.php");

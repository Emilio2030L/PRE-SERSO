...
require("../conexion/connect_db.php");
  ...
  $sql="SELECT * FROM altalumno INNER JOIN alumnos ON alumnos.matriculaAlumno = altalumno.matriculaAlumno INNER JOIN programaeducativo ON programaeducativo.idPrograma = alumnos.idPrograma WHERE matriculaProfesor =  '$ma' and programaeducativo.idPrograma = '$pro'";

...
<html lang="en">
  ...
  <body class="">
    ...
    <h1 class="text-dark text-center">Registro unidad receptora</h1>
    ...
    <form class="formulario" id="formulario">
      ...
      <div class="formulario__grupo" id="grupo__nombreUnidad">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="nombreUnidad" id="nombreUnidad" placeholder="EJ: Instituto nacional electoral INE">
      ...
      <div class="formulario__grupo" id="grupo__domicilioUni">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="domicilioUni" id="domicilioUni" placeholder="EJ: calle, colonia, municipio, estado">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El nombre tiene que ser de 4 a 20 dígitos y solo puede contener numeros, letras y guion bajo.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__telefonoUni">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="telefonoUni" id="telefonoUni" placeholder="EJ: 7771234567">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario_grupo" id="grupo_numTrabajadores">
        ...
        <div class="formulario__grupo-input">
                    <select name="numTrabajadores" class="formulario__input" id="numTrabajadores">
                        <option value="1-10" selected>1-10 trabajadores</option> 
      ...
      <div class="formulario__grupo formulario__grupo-btn-enviar">
        <button type="submit" class="formulario__btn" onclick="regUnidad()">Enviar</button>
